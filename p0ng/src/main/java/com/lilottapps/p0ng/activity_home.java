...
public class activity_home extends ActionBarActivity {
    ...
    public void startSinglePlayer(View v) {
        Intent i = new Intent(this, activity_singleplayer.class);
        startActivity(i);
    }

    public void startMultiPlayer(View v) {
        Intent i = new Intent(this, activity_multiplayer.class);
        startActivity(i);
    }

    public void startLeaderBoards(View v) {
        Intent i = new Intent(this, activity_leaderboards.class);
        startActivity(i);
    }
